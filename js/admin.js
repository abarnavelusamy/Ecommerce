...
document.getElementById('addProductForm').addEventListener('submit', function(e) {
  ...
  const credit = parseInt(document.getElementById('productCredit').value, 10);
  ...
  if (isNaN(price) || price < 1) {
    document.getElementById('priceError').innerText = "The value can't be negative or zero";
    isValid = false;
  }
  if (isNaN(credit) || credit < 1) {
    document.getElementById('creditError').innerText = "The value can't be negative or zero";
    isValid = false;
  }
  if (isNaN(stock) || stock < 1) {
    document.getElementById('stockError').innerText = "The value can't be negative or zero";
    isValid = false;
  }
...
document.getElementById('updateProductForm').addEventListener('submit', function(e) {
  ...
  const price = parseInt(document.getElementById('updateProductPrice').value, 10);
  const credit = parseInt(document.getElementById('updateProductCredit').value, 10);
  const stock = parseInt(document.getElementById('updateProductStock').value, 10);
  ...
  if (!name || isNaN(price) || isNaN(credit) || isNaN(stock) || !category) {
